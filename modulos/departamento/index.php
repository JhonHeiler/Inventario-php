...
<body>
   ...
   <div id="contenedor-listado" class="content mt-3" style="/*width:800px;*/ margin:auto">
    ...
    <div id="contenedor-formulario" class="content mt-3" style="width:800px; margin:auto; display:none ">
        ...
        <div class="card">
            <div class="card-header">
                <span id="titulo"> Departamento</span>
            </div>
                ...
                <form id="formulario" method="post" action="guardar.php">
                    <input type="hidden" name="id_departamento" id="id_departamento" />
                     ...
                     <div class="form-group row">
                        <label for="nombre" class="col-sm-3 col-form-label">Nombre </label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del departamento" >
                        </div>
                    </div> 
    ...
    <script type="text/javascript">
        ...
        function eliminar(id_departamento) {
            if (confirm("¿Realmente desea eliminar el registro?")) {
                var parametros = "id_departamento=" + id_departamento;
       ...
       function modificar(id_departamento) {
            $("#titulo").html("Modificar departamento");
            var parametros = "id_departamento=" + id_departamento;
            $.get("?modulo=departamento&accion=cargar-datos", parametros, function(respuesta) {
                $("#formulario")[0].reset(); //limpiar formulario
                $("#contenedor-listado").hide();
                $("#contenedor-formulario").show();
        ...
        function mostrar(id_departamento) {
            $("#titulo").html("Mostrar departamento");
            var parametros = "id_departamento=" + id_departamento;
            $.get("?modulo=departamento&accion=cargar-datos", parametros, function(respuesta) {
                $("#formulario")[0].reset(); //limpiar formulario
                $("#contenedor-listado").hide();
