...
$sql_cantidad = "SELECT COUNT(*) AS cantidad FROM entrega";
...
<table class="table table-striped" >
    ...
    <tbody>
        ...
        if (isset($_GET['id_producto']) == true &&  $_GET['id_producto']  != "") {
            $filtros .= " AND e.id_producto = '$_GET[id_producto]' ";
        }


        if (isset($_GET['respon']) == true && $_GET['respon'] != "") {
            $filtros .= " AND e.respon = '$_GET[respon]' "; 
        }
        ...
        while ($row = mysqli_fetch_assoc($rmu)) {
            ...
            echo "<td>$row[fecha_ad]</td>";
            echo "<td>$row[fecha_en]</td>";
            
            echo "<td>$row[nombre]</td>";
            echo "<td>$row[cantidad]</td>";
            echo "<td>$row[cargo]</td>";
             echo "<td class='acciones'>
                   <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$row[id_entrega]\")'>
