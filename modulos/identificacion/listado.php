...
$sql_cantidad = "SELECT COUNT(*) AS cantidad FROM identificacion";
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        if (isset($_GET['nombre']) == true &&  $_GET['nombre']  != "") {
            ...
            $filtros .= " AND CONCAT_WS(' ',i.nombre,i.abre) LIKE '%$nombre%'  ";
        }
        ...
        while ($row = mysqli_fetch_assoc($rmu)) {
            ...
            echo "<td>$row[abre]</td>";
              ...
              echo "<td class='acciones'>
                <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$row[id_identificacion]\")'>
                        <i class='fas fa-eye'></i>
                    </a>                  
                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$row[id_identificacion]\")'>
                        <i class='fas fa-trash'></i>
                    </a>
                    <a href='javascript:;' class='modificar' onclick='modificar(\"$row[id_identificacion]\")'>
