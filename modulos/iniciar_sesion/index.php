...
<div id="" class="content mt-5 mb-5" style="width:500px; margin:auto; margin:left">
<?php
        ...
        <div class="card-body">
            <form id="formulario" method="post" action="guardar.php">
                ...
                <div class="form-group row mb-0">
                    ...
                    <a href="?modulo=registrarse&accion=ver" class="btn btn-lg btn-block btn-secondary" style="color: #ffffff; width: 200px;"> Registrarse</a>
                       
                    </div>
                    <div class="col-sm-6 text-right">
                        <button type="button" id="btn-iniciar" class="btn btn-lg btn-block btn-primary">Iniciar</button>
                    </div>
