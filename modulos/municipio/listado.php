...
$sql_cantidad = "SELECT COUNT(*) AS cantidad FROM municipio";
        ...
        while ($row = mysqli_fetch_assoc($rmu)) {
            ...
            echo "<td>$row[departamento]</td>";
              ...
              echo "<td class='acciones'>
                <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$row[id_municipio]\")'>
                        <i class='fas fa-eye'></i>
                    </a>                  
                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$row[id_municipio]\")'>
                        <i class='fas fa-trash'></i>
                    </a>
                    <a href='javascript:;' class='modificar' onclick='modificar(\"$row[id_municipio]\")'>
