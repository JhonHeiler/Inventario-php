...
$sql_cantidad = "SELECT COUNT(*) AS cantidad FROM permiso_rol";
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        if (isset($_GET['modulo1']) == true &&  $_GET['modulo1']  != "") {
            ...
            $filtros .= " AND CONCAT_WS(' ',p.modulo1) LIKE '%$modulo1%'  ";
        }
        if (isset($_GET['accion1']) == true &&  $_GET['accion1']  != "") {
            $accion1 = $_GET['accion1'];
            $accion1 = str_replace(" ", "%", $accion1);
            $filtros .= " AND CONCAT_WS(' ',p.accion1) LIKE '%$accion1%'  ";
        }
        ...
        while ($row = mysqli_fetch_assoc($rmu)) {
            ...
            echo "<td class='acciones'>
                    ...
                    <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$row[id_permiso_rol]\")'>
