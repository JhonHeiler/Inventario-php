...
<table class="table table-striped" >
    ...
    <tbody>
       ...
       if (isset($_GET['nombre']) == true &&  $_GET['nombre']  != "") {
            ...
            $filtros .= " AND CONCAT_WS(' ',p.nombre) LIKE '%$nombre%'  ";
        }
        

        if (isset($_GET['fecha']) == true && $_GET['fecha'] != "") {
            $filtros .= " AND p.fecha = '$_GET[fecha]' "; 
        }

         if (isset($_GET['id_provedor']) == true && $_GET['id_provedor'] != "") {
            $filtros .= " AND p.id_provedor = '$_GET[id_provedor]' "; 
        }

        if (isset($_GET['id_categoria']) == true && $_GET['id_categoria'] != "") {
            $filtros .= " AND p.id_categoria = '$_GET[id_categoria]' "; 
        }
        ...
        $sql = "SELECT 
                ...
                join categoria on p.id_categoria=categoria.id_categoria
        ...
        while ($row = mysqli_fetch_assoc($rmu)) {
            ...
            echo "<td>$row[categoria]</td>";
             echo "<td class='acciones'>
                    ...
                    <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$row[id_producto]\")'>
