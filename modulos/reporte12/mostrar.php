...
<table style="font-family:'Times New Roman', Times, serif; font-size:8pt; 
    ...
    <thead>
        <tr style="font-weight:bold; text-align:left; background-color:#e1e1e1">
            <tr style=" text-align: center; background-color:#e1e1e1">Lista de devoluciones por producto</tr>
            ...
            <th style="width:30mm">Tol. devoluciones producto </th>
        </tr>
    </thead>
