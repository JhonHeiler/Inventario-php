...
<table style="font-family:'Times New Roman', Times, serif; font-size:8pt; 
    ...
    <thead>
        <tr style="font-weight:bold; text-align:left; background-color:#e1e1e1">
            <tr style=" text-align: center; font-weight:bold;">Lista de Categorías</tr>
            <th style="width:10mm">No</th>
            <th style="width:40mm">Categorías</th>
        </tr>
    </thead>
...
<?php
        ...
        if ($formato == "html") {
            ...
            header("Content-Disposition: attachment; filename=Listado de categorias .doc;");
            echo $html;
 
        } else if ($formato == "xls") {
            header("Content-Type: application/download");
            header("Content-Disposition: attachment; filename=Listado de categorias .xls;");
            echo $html;
        } else if($formato=="pdf") {
            ...
            $pdf->Output('listado de categorias .pdf', 'I');
