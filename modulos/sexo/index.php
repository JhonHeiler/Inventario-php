   ...
   <div id="contenedor-listado" class="content mt-3" style="/*width:800px;*/ margin:auto">
        ...
        <div class="card">
            ...
            <div id="div-formulario-busqueda" class="card-body d-none">
                ...
                <form id="formulario-busqueda" method="post" >
                    <input type="hidden" name="id_sexo"  />
                ...
                <form id="formulario" method="post" action="guardar.php">
                    <input type="hidden" name="id_sexo" id="id_sexo" />
                     ...
                     <div class="form-group row">
                        <label for="nombre" class="col-sm-3 col-form-label">Nombre </label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del sexo" >
                        </div>
                    </div> 
    ...
    <script type="text/javascript">
       ...
       function modificar(id_sexo) {
            $("#titulo").html("Modificar sexo");
            var parametros = "id_sexo=" + id_sexo;
            $.get("?modulo=sexo&accion=cargar-datos", parametros, function(respuesta) {
                $("#formulario")[0].reset(); //limpiar formulario
                $("#contenedor-listado").hide();
                $("#contenedor-formulario").show();
