...
<table class="table table-striped">
    ...
    <tbody>
        ...
        if (isset($_GET['nombre']) == true &&  $_GET['nombre']  != "") {
            ...
            $filtros .= " AND CONCAT_WS(' ',s.nombre) LIKE '%$nombre%'  ";
        }
        ...
        while ($row = mysqli_fetch_assoc($rmu)) {
            ...
            echo "<td>$row[nombre]</td>";
              ...
              echo "<td class='acciones'>
                <a href='javascript:;' class='mostrar'  onclick='mostrar(\"$row[id_sexo]\")'>
                        <i class='fas fa-eye'></i>
                    </a>                  
                    <a href='javascript:;' class='eliminar' onclick='eliminar(\"$row[id_sexo]\")'>
                        <i class='fas fa-trash'></i>
                    </a>
                    <a href='javascript:;' class='modificar' onclick='modificar(\"$row[id_sexo]\")'>
